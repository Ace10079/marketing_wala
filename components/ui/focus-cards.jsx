...
export const Card = React.memo(({
  ...
  <div
    ...
    className={cn(
        "rounded-lg mt-10 relative overflow-hidden h-40 md:h-60 w-full transition-all duration-300 ease-out",
...
export function FocusCards({
  ...
  return (
    <div
    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-7xl mx-auto px-4 w-full">

    ...
    <div className={cn("relative w-fit", containerClassName)} ref={containerRef}>
      ...
      {dimensions.width > 0 && dimensions.height > 0 && (
        <motion.div
          ...
          <motion.div
  className={cn(
    "absolute inset-0 border border-black ",
    rectangleClassName
  )}
  animate={{
    scale: [1, 1.05, 1],
...
<motion.div
  ...
  animate={{
    opacity: [1, 0.6, 1],
    x: [dimensions.width + 4, dimensions.width + 10, dimensions.width + 4],
    y: [dimensions.height + 4, dimensions.height + 10, dimensions.height + 4],
  }}
  style={{ rotate: -90 }}
  transition={{
    duration: 2,
